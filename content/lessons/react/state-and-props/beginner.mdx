...
**Excellent work!**  You now understand the fundamentals of props and state. In the intermediate level, we'll explore more advanced patterns like prop drilling, lifting state up, and controlled components.
