...
Common patterns:
- `odd` or `2n+1` — odd elements (1st, 3rd, 5th...)
- `even` or `2n` — even elements (2nd, 4th, 6th...)
- `3n` — every 3rd element (3rd, 6th, 9th...)
- `n+4` — 4th element and beyond
...
**Great progress!**  You now have a solid understanding of practical selector techniques and specificity. In the advanced level, we'll explore cutting-edge selectors, complex specificity scenarios, and performance considerations.
