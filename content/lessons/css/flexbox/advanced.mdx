...
Step 3: Distribute by grow ratio (1:2:1)
  - Total grow = 1 + 2 + 1 = 4
  - Item 1 gets: 200 + (400 × 1/4) = 300px
  - Item 2 gets: 300 + (400 × 2/4) = 500px
  - Item 3 gets: 100 + (400 × 1/4) = 200px
*/
```
...
**Congratulations!**  You've mastered advanced CSS Flexbox. You now understand:
