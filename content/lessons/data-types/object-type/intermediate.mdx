...
> ️ **Watch out!** This is a common source of bugs. When you pass an object to a function, the function can modify your original object.
...
console.log(deep.nested.value); // Still 1 ✅
```
