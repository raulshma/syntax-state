...
if (!x) console.log("x is falsy"); // ✅ Runs
if (!y) console.log("y is falsy"); // ✅ Runs
```

> ️ `typeof null === "object"` is a famous JavaScript bug from 1995 that can never be fixed for backwards compatibility!
...
10n + 5; // ❌ TypeError!
10n + BigInt(5); // ✅ 15n
10n / 3n; // ✅ 3n (truncated, no decimals)
```
