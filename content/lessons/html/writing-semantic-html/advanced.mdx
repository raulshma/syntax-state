...
Welcome to the advanced level! You've mastered semantic elements — now let's explore how assistive technologies interpret your markup, dive deep into ARIA roles, and learn advanced patterns for creating truly accessible web experiences.
...
1. **DOM Tree** — The structure of elements
2. **Accessibility Tree** — A simplified tree for assistive technologies

The accessibility tree strips away visual styling and focuses on:
- **Role** — What type of element is this?
- **Name** — What is it called?
- **State** — Is it expanded, checked, disabled?
