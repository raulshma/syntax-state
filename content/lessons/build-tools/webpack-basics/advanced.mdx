  ...
  apply(compiler) {
    compiler.hooks.done.tap('SimpleBundleAnalyzer', (stats) => {
      ...
      for (const asset of sortedAssets) {
        ...
        const bar = '█'.repeat(Math.min(Math.floor(asset.size / 10000), 30))
...
**Congratulations!**  You've mastered Webpack at an advanced level. You can now build custom plugins, optimize production builds, and implement advanced patterns like Module Federation!
